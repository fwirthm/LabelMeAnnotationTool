...
function LMgetObjectField(xml,ind_object, name, frame) {
	...
	if (name == 'name' ||  name == 'attributes' || name == 'occluded'|| name == 'difficult'|| name == 'pose'){
...
function LMsetObjectField(xml, ind_object, name, value){
	var obj = $(xml).children("annotation").children("object").eq(ind_object);
	if (name == 'name' || name == 'automatic' || name == 'attributes' || name == 'occluded' || name == 'difficult' || name == 'pose' || name == 'deleted' || name == 'id'){
